<template>
  <div>
    <h1 class="display-2">Privacy Policy for DemBoost</h1>

    <p class="body-1">
      At Vuetify Template, accessible from ..., one of our main priorities is the privacy of our visitors. This Privacy
      Policy document contains types of information that is collected and recorded by Vuetify Template and how we use
      it.
    </p>
    ...
    <p>
      ...
      the information that they shared and/or collect in Vuetify Template. This policy is not applicable to any
    ...
    <h2 class="display-1">Consent</h2>

    <p class="body-1">By using our website, you hereby consent to our Privacy Policy and agree to its terms.</p>

    <h2 class="display-1">Information we collect</h2>
    ...
    <h2 class="display-1">How we use your information</h2>

    <p class="body-1">We use the information we collect in various ways, including to:</p>
    ...
    <h2 class="display-1">Log Files</h2>

    <p class="body-1">
      Vuetify Template follows a standard procedure of using log files. These files log visitors when they visit
    ...
    <h2 class="display-1">Advertising Partners Privacy Policies</h2>

    <P
      >You may consult this list to find the Privacy Policy for each of the advertising partners of Vuetify Template.</P
    >

    <p class="body-1">
      Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in
      their respective advertisements and links that appear on Vuetify Template, which are sent directly to users'
    ...
    <p class="body-1">
      Note that Vuetify Template has no access to or control over these cookies that are used by third-party
      advertisers.
    </p>

    <h2 class="display-1">Third Party Privacy Policies</h2>

    <p class="body-1">
      Vuetify Template's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
    ...
    <h2 class="display-1">GDPR Data Protection Rights</h2>
